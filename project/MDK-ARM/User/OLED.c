...
void OLED_BMP(unsigned char BMP[])
{	
		 OLED_Clear();
		 OLED_DrawBMP(0,0,127,0,BMP);
		 OLED_DrawBMP(0,0,127,1,BMP);
		 OLED_DrawBMP(0,0,127,2,BMP);
		 OLED_DrawBMP(0,0,127,3,BMP);
		 OLED_DrawBMP(0,0,127,4,BMP);
		 OLED_DrawBMP(0,0,127,5,BMP);
		 OLED_DrawBMP(0,0,127,6,BMP);
